...
<html lang="en">
    <head>
        ...
        <script src="../javascript/index/jqcloud.js"></script>
        <link rel="stylesheet" href="../css/jqcloud.css">
        <script src="../javascript/index/word-cloud.js" type="text/javascript"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.js"></script>   
        <script src="../javascript/index/bar.js" type="text/javascript"></script>
        <script src='https://cdn.plot.ly/plotly-latest.min.js'></script>
        <script src="../javascript/index/map.js" type="text/javascript"></script>
    </head>
    <body>
    <div id="body">
        <div id="nav">
        ...
        <div id="form">
            <form action="results/results.php" method="POST">
